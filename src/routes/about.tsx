  ...
  return (
    <PageShell>
      <div className="text-justify">
        <p>
          I grew up playing a lot of sports and reading quite a lot. <em>Diary of a Wimpy Kid</em> was my holy grail. I also would tinker around with small dc motor kits that I turned into bottle boats, an RC car and a mini JCB — while also painting and quilling. Thus came my habit of breaking apart and building things. I'm naturally curious and am inclined to having conversations where I don't know anything. TIL (today I learned) is my fav sub reddit and frequently refer to &ldquo;When breath becomes air&rdquo; as the book that changed the way I valued time (that's a whole other conversation).
        </p>
        <p>
        ...
        <p>
          Some weekends are spent riding bikes with my dad and my close friends, into places that are scenic, or to places that one shouldn't go to. We usually end up with 5 good stories to tell after each trip. No feeling comes close to riding.  
        </p>
        <p>
